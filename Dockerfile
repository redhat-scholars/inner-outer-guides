...
LABEL org.opencontainers.image.source="git@github.com:redhat-scholars/inner-outer-tutorial"
LABEL org.opencontainers.image.documentation="https://github.com/redhat-scholars/inner-outer-tutorial"
